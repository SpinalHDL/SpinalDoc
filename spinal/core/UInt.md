---
layout: page
title: Unsigned integer (UInt)
description: "Unsigned integer data type"
tags: [UInt unsigned integer]
categories: [documentation, types, UInt, unsigned, integer]
permalink: /spinal/core/types/UInt
sidebar: spinal_sidebar
---
### Description
The `UInt` type corresponds to a vector of bits that can be used for unsigned
arithmetic.

### Declaration
The syntax to declare an unsigned integer is as follows:
