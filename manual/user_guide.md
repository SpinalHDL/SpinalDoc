...
## Document purpose
This document presents Spinal, how to use it on concrete examples and how it is implemented. 
...
# spinal.core
The core components of the language are described in this chapter.
...
Those types store multiple bits of information in a single value. ´Bits´ do not convey any sign information whereas the ´UInt´ (unsigned integer) and ´SInt´ (signed integer) provide the required operations to compute correct results if signed / unsigned arithmetics is used.
